<template lang="pug">
nav.nav
  a-dropdown.nav__burger(v-if="windowWidth < deviceSizes.tablet" :trigger="['click']")
    template(#overlay)
      NavListComponent
    a-button
  ...
  NavListComponent.nav__list(v-else)
</template>

<script>
import NavListComponent from '@/components/UI/NavListComponent'
import useWidth from '@/hooks/useWidth'
import useDeviceSizes from '@/hooks/useDeviceSizes'

export default {
  name: 'NavComponents',
  components: {NavListComponent},
  setup() {
